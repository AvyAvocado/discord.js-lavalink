...
class PlayerManager extends Collection {
   ...
   * @param {string} data.vchannel VoiceChannel id
   * @param {string} data.tchannel TextChannel id
   ...
   *  vchannel: "412180910587379716",
   *  tchannel:"412180910587379721"
   *  host: "localhost"
   * });
   */
  join(data, {
